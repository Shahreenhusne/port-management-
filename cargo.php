...
<ul align="center">
<li><a href="./vessels.php"><button type="button">Vessels</button></a></li>
...
$sqlget = "select cargo_id, size from cargo order by size ASC";
$sqldata = mysqli_query($conn,$sqlget) or die('error getting connection');

echo "<table>";
echo "<tr><th>Cargo ID</th><th>Container Size Ft</th></tr>";
